...
pub trait FungibleTokenCore {
    ...
    /// Both accounts must be registered with the contract for transfer to succeed. (See [NEP-145](https://github.com/unc/NEPs/discussions/145))
    /// This method must to be able to accept attached deposits, and must not panic on attached deposit.
    /// Exactly 1 yoctoNEAR must be attached.
    /// See [the Security section](https://github.com/unc/NEPs/issues/141#user-content-security) of the standard.
    ///
    /// Arguments:
    ...
    /// amount, the remaining balance must be refunded. See [the Security section](https://github.com/unc/NEPs/issues/141#user-content-security) of the standard.
    ///
    ...
    /// section](https://github.com/unc/NEPs/issues/141#user-content-security) of the standard.
    ///
    /// Arguments:
