...
#[macro_export]
#[deprecated(
    note = "implement the unc_contract_standards::fungible_token::{FungibleTokenCore, FungibleTokenResolver} traits manually instead."
)]
...
#[macro_export]
#[deprecated(
    note = "implement the unc_contract_standards::fungible_token::StorageManagement trait manually instead."
)]
