...
#[macro_export]
#[deprecated(
    note = "implement the unc_contract_standards::non_fungible_token::NonFungibleTokenCore and unc_contract_standards::non_fungible_token::NonFungibleTokenResolver traits manually instead."
)]
...
#[macro_export]
#[deprecated(
    note = "implement the unc_contract_standards::non_fungible_token::NonFungibleTokenApproval trait manually instead."
)]
...
#[macro_export]
#[deprecated(
    note = "implement the unc_contract_standards::non_fungible_token::NonFungibleTokenEnumeration trait manually instead."
)]
macro_rules! impl_non_fungible_token_enumeration {
    ($contract: ident, $token: ident) => {
        ...
        impl NonFungibleTokenEnumeration for $contract {
            fn nft_total_supply(&self) -> unc_sdk::json_types::U128 {
                self.$token.nft_total_supply()
            }

            fn nft_tokens(
                &self,
                from_index: Option<unc_sdk::json_types::U128>,
                limit: Option<u64>,
            ) -> Vec<Token> {
                self.$token.nft_tokens(from_index, limit)
            }

            fn nft_supply_for_owner(&self, account_id: AccountId) -> unc_sdk::json_types::U128 {
