...
/// This structure is similar to [`unc_sdk::store::LookupMap`](crate::store::LookupMap), except
...
/// [`unc_sdk::store::key`](crate::store::key).
///
///
/// # Examples
/// ```
    ...
    H: ToKey,
{
    ...
    // See https://github.com/unc/unc-sdk-rs/issues/1134 to understand the difference between
