//!This file is to be removed once unc-vm-logic is updated from version 0.17 and MockedMemory size can be customized
use unc_vm_runner::logic::{MemSlice, MemoryLike};
