...
pub fn test_vm_config() -> unc_parameters::vm::Config {
...
struct LogicFixture {
    ...
    config: Box<unc_parameters::vm::Config>,
...
impl MockedBlockchain {
    pub fn new(
        context: VMContext,
        config: unc_parameters::vm::Config,
        fees_config: RuntimeFeesConfig,
        promise_results: Vec<PromiseResult>,
        storage: HashMap<Vec<u8>, Vec<u8>>,
        validators: HashMap<String, UncToken>,
        ...
        let logic = unsafe {
            VMLogic::new(
                ...
                context,
                &*(logic_fixture.config.as_mut() as *const unc_parameters::vm::Config),
...
fn sdk_context_to_vm_context(context: VMContext) -> unc_vm_runner::logic::VMContext {
    unc_vm_runner::logic::VMContext {
...
mod mock_chain {
    use unc_vm_runner::logic::{errors::VMLogicError, VMLogic};
