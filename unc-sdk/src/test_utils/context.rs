...
impl VMContextBuilder {
    ...
    pub fn account_balance(&mut self, amount: UncToken) -> &mut Self {
        self.context.account_balance = amount;
        self
    }

    pub fn account_locked_balance(&mut self, amount: UncToken) -> &mut Self {
    ...
    pub fn attached_deposit(&mut self, amount: UncToken) -> &mut Self {
